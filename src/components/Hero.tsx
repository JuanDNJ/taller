        ...
        <Container variant='full' className="relative h-screen" >
            ...
            <article className="max-w-7xl flex justify-center absolute top-0 left-0 flex flex-col h-full w-full px-4 md:px-8">
                <section className="flex flex-col">
                    <TitlePage tag="h1" label={label} className='text-white'/>
                    <article className="mt-8 text-white">
                        ...
                        <footer className="mt-8 lg:py-12 flex flex-col justify-end md:flex-row space-y-4 md:space-y-0 md:space-x-4 ">
                            ...
                            <Btn className="text-xl bg-yellow-500/10 border-yellow-500/50 hover:bg-yellow-500/20 py-2 px-4" label="Ver tu proceso" onClick={() => console.log('Progress button clicked')} />
                        </footer>
                    </article>
                </section>
            </article>
